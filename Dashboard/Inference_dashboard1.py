...
expected_feature_cols = [f'OpSet{i}' for i in range(1, 4)] + [f'Sensor{i}' for i in selected_sensors]
...
if uploaded_file:
    ...
    if st.button("Run Prediction"):
        ...
        # Show only selected features + target
        display_cols = [f'OpSet{i}' for i in range(1, 4)] + [f'Sensor{i}' for i in selected_sensors] + ['RUL_label']
